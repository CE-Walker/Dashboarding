...
rCand <- function(df,clicked_dist){
  if(clicked_dist == "NA"){
    ...
    data <- df %>% as.data.frame() %>% filter(District == clicked_dist) %>% select(candidate_Republican) %>% as.character() 
  }
}
...
rCash <- function(df,clicked_dist){
  if(clicked_dist == "NA"){
    ...
    data <- df %>% as.data.frame() %>% filter(District == clicked_dist) %>% select(total_cash_Republican) %>% as.numeric() %>% dollar()
...
rRaised <- function(df,clicked_dist){
  if(clicked_dist == "NA"){
    ...
    data <- df %>% as.data.frame() %>% filter(District == clicked_dist) %>% select(total_raised_Republican) %>% as.numeric() %>% dollar()
...
dCand <- function(df,clicked_dist){
  if(clicked_dist == "NA"){
    ...
    data <- df %>% as.data.frame() %>% filter(District == clicked_dist) %>% select(candidate_Democratic) %>% as.character() 
  }
}
...
dCash <- function(df,clicked_dist){
  if(clicked_dist == "NA"){
    ...
    data <- df %>% as.data.frame() %>% filter(District == clicked_dist) %>% select(total_cash_Democratic) %>% as.numeric() %>% dollar()
    paste0("Cash on Hand: ",data)
  }
}
...
dRaised <- function(df,clicked_dist){
  if(clicked_dist == "NA"){
    ...
    data <- df %>% as.data.frame() %>% filter(District == clicked_dist) %>% select(total_raised_Democratic) %>% as.numeric() %>% dollar()
    paste0("Total Raised: ",data)
  }
}
...
election_bar <- function(df,election){
  ...
  data <- df %>% as.data.frame() %>% group_by(result) %>% summarize(res_count = n())
